...
function Nav() {
    ...
    return (
        <nav className="z-10 bg-white shadow-md w-56 fixed flex flex-col justify-between top-0 left-0 bottom-0">
            ...
            <button type="button" onClick={logout} className="bg-red-700 text-white hover:text-red-700 py-2 font-normal hover:border hover:border-red-700 hover:bg-white">
                Deconnexion
            </button>
        </nav>
    )
