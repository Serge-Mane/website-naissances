...
const ERROR_MESSAGE = "Ce champs est requis";
const schema = yup
    .object({
        message: yup.string(),
        date: yup.string(),
        ...
        parent: yup.object({
            ...
            adresse: yup.string().required(ERROR_MESSAGE),
            gender: yup.string(),
        }),
    })
    .required();
...
function RequestEdit() {
    ...
    return (
        ...
        <article className="bg-white shadow-md rounded-md w-1/2 mx-auto p-4">
            ...
            {view === "FORM" ? (<form onSubmit={handleSubmit(save)}>
                ...
                <div className="form-field">
                    <label htmlFor="parent-adresse">Adresse du parent</label>
                    <input
                        type="text"
                        id="parent-adresse"
                        placeholder="Adresse du parent"
                        {...register("parent.adresse")}
                    />
                    <p className="text-red-600">
                        {errors.parent?.adresse?.message}
                    </p>
                </div>
                <div className="form-field">
